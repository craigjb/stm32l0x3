...
#[doc = r" Proxy"]
pub struct _TOUCHSMENW<'a> {
    w: &'a mut W,
}
impl<'a> _TOUCHSMENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn crypsmen(&self) -> CRYPSMENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 24;
    ...
    #[inline]
    pub fn touchsmen(&self) -> TOUCHSMENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 24 - Crypto clock enable during sleep mode bit"]
    #[inline]
    pub fn crypsmen(&mut self) -> _CRYPSMENW {
        _CRYPSMENW { w: self }
    }
    #[doc = "Bit 20 - Random Number Generator clock enable during sleep mode bit"]
    #[inline]
    ...
    #[doc = "Bit 16 - Touch Sensing clock enable during sleep mode bit"]
    #[inline]
    pub fn touchsmen(&mut self) -> _TOUCHSMENW {
        _TOUCHSMENW { w: self }
    }
    #[doc = "Bit 12 - CRC clock enable during sleep mode bit"]
    #[inline]
