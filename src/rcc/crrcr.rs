...
#[doc = r" Proxy"]
pub struct _HSI48DIV6ENW<'a> {
    w: &'a mut W,
}
impl<'a> _HSI48DIV6ENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn hsi48div6en(&self) -> HSI48DIV6ENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 2 - 48 MHz HSI clock divided by 6 output enable"]
    #[inline]
    pub fn hsi48div6en(&mut self) -> _HSI48DIV6ENW {
        _HSI48DIV6ENW { w: self }
    }
}
