...
#[doc = r" Proxy"]
pub struct _LPUART12RSTW<'a> {
    w: &'a mut W,
}
impl<'a> _LPUART12RSTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn lpuart12rst(&self) -> LPUART12RSTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 17;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 17 - UART2 reset"]
    #[inline]
    pub fn lpuart12rst(&mut self) -> _LPUART12RSTW {
        _LPUART12RSTW { w: self }
    }
    #[doc = "Bit 14 - SPI2 reset"]
    #[inline]
    ...
    #[doc = "Bit 11 - Window watchdog reset"]
    #[inline]
    pub fn wwdrst(&mut self) -> _WWDRSTW {
        _WWDRSTW { w: self }
    }
    #[doc = "Bit 4 - Timer 6 reset"]
    #[inline]
